...
describe Api do
  ...
  it 'should get ranking of 20 names most used in Santo André (SP) to female sex' do
  ...
  it 'should get ranking of 20 names most used in Santo André (SP) to male sex' do
